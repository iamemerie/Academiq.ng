  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-16 py-10">
        ...
        <p className="text-gray-500 mt-2">Find the right tutor for your various needs</p>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {loading ? (
            ...
            tutors.map((tutor) => (
              <div key={tutor._id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">{tutor.fullName}</h3>
