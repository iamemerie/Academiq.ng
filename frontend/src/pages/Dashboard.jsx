...
function Dashboard() {
  ...
  // FIX 1: Extracted out of useEffect so it can be invoked after a new post submission
  ...
  useEffect(() => {
    fetchRequests();
  }, []); // Still handles the initial mounting fetch cleanly
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          {role === "student" ? (
            <>
              <div className="bg-white border border-gray-200 rounded-2xl p-6 w-60 text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-500 text-sm mb-4">
                  Need help? Post your request now.
                </p>
                <button
                  onClick={openModal}
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 w-60 text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-500 text-sm mb-4">
                  Find the right tutor for you here.
                </p>
                <a
                  href="/browse-tutors"
                  className="bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-700"
            ...
            <>
              <div className="bg-white border border-gray-200 rounded-2xl p-6 w-60 text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-500 text-sm mb-4">
                  Find students who need your help.
                </p>
                <a
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">
                          {request.subject} • {request.level} Level
                        </p>
      ...
      {/* FIX 2: Passed fetchRequests into your modal as a callback utility */}
      {isModalOpen && (
