      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
        ...
        <div className="flex justify-between items-center px-8 pt-8 pb-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Describe the help you need</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="px-8 py-6 flex flex-col gap-4">
          ...
          {/* School Type */}
          <div>
            <label className="block text-sm font-semibold text-gray-600 mb-1">School Type</label>
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => setFormData({ ...formData, schoolType: 'university', level: '' })}
                className={`flex-1 py-3 rounded-xl border-2 text-sm font-semibold transition-all ${formData.schoolType === 'university'
              ...
              <button
                type="button"
                onClick={() => setFormData({ ...formData, schoolType: 'secondary', level: '' })}
                className={`flex-1 py-3 rounded-xl border-2 text-sm font-semibold transition-all ${formData.schoolType === 'secondary'
                  ? 'border-indigo-600 bg-indigo-50 text-indigo-600'
                  : 'border-gray-200 text-gray-500'
                  }`}
              >
